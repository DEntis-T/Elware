...
echo All directories needed for program or software files successfully created. Sames are located on disc 'C:'! Note that these files won't touck any other folders located on same location.
echo.
